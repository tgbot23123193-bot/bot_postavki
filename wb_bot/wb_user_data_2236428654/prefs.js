...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1758221024);
user_pref("app.update.lastUpdateTime.background-update-timer", 1758221024);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1758221024);
user_pref("app.update.lastUpdateTime.region-update-timer", 1758221024);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1758221024);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1758221024);
...
user_pref("browser.contextual-services.contextId", "f57d64a2-600b-436c-8d11-c9fd7cb31ac3");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1758220993);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{8a3ee770-98c9-4e4e-a689-aaf486527c27}");
...
user_pref("browser.startup.lastColdStartupCheck", 1758220994);
...
user_pref("datareporting.dau.cachedUsageProfileGroupID", "5d812722-6de2-4f3c-8dc3-a5f79bff2774");
user_pref("datareporting.dau.cachedUsageProfileID", "c452d86d-5a33-4e08-91e6-0c90642f36fd");
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBcR2/ItQ+4PBAjOJGIIQE2F1w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"faa51bd4-82df-44b4-a1cf-30d612fa7826\",\"newtab@mozilla.org\":\"fdeb6387-4273-4604-ba38-886ca8b439a8\",\"pictureinpicture@mozilla.org\":\"4ea8020a-5683-4d9f-94db-aa36a6595ec2\",\"addons-search-detection@mozilla.com\":\"caa7cafe-6d04-405c-9dff-bd1778fd8cd3\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"default-theme@mozilla.org\":\"727b86a8-c919-4bae-a94a-47384afb433a\"}");
...
user_pref("nimbus.profileId", "60a0802c-e2e2-4ad0-9572-5dad5973fcb9");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECI5v2Siq/zTqBAjjRsjgmAypwQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "8af85930");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1758220992);
